...
export const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-slate-950 transition-colors duration-300 w-full overflow-x-hidden">
            ...
            <div className="flex-shrink-0 flex items-center gap-2">
              ...
              >
                ...
                <span className="font-bold text-xl tracking-tight text-slate-900 dark:text-white">
                  TechStack <span className="hidden sm:inline">Conference</span> <span className="text-primary-600 dark:text-primary-400">2026</span>
                </span>
              </Link>
            </div>
