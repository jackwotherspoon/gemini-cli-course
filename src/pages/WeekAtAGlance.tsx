...
export const WeekAtAGlance = () => {
  ...
  return (
    <div className="py-24 bg-slate-50 dark:bg-slate-900 w-full overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-start">
          {[
            ...
            <motion.div 
              ...
              className="bg-white dark:bg-slate-950 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm flex flex-col h-full"
            >
